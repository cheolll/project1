	...
	public void purchaseProduct(Long productNumber, Member member, String ckeckEmail, int quantity) {
		...
		if (check == 1) {
			...
			try {
	            ...
	            // 이미지 첨부
	            String imageFolderPath = "/Users/yerimi/SpringBoot/Workspace/E1I4S/src/main/resources/static/productImage";
	            String imageName = pointShop.getProductImage();
	            
	            String additionFilePath = "/Users/yerimi/SpringBoot/Workspace/E1I4S/src/main/resources/static/productImage";
