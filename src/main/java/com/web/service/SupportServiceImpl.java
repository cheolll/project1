...
public class SupportServiceImpl implements SupportService, FolderPathREPO {
	...
	public void find2List(Inquery inquery, Report report, Pageable pageable1, Pageable pageable3,
						  String searchKeyword1, String searchKeyword3, Model model) {
		// TODO Auto-generated method stub
		Page<Inquery> inqueryList1;
		if(searchKeyword1!=null) {
			inqueryList1 = inqueryRepo.findByInqueryTitleContainingAndInqueryAnswerIsNotNull(pageable1, searchKeyword1);
		}else {
			inqueryList1 = inqueryRepo.findByInqueryAnswerIsNotNull(pageable1);
		}
		int nowPage1 = inqueryList1.getPageable().getPageNumber()+1;
		...
		Page<Report> reportList;
		if(searchKeyword3!=null) {
			reportList = reportRepo.findByReportTitleContainingAndReportAnswerIsNotNull(pageable3, searchKeyword3);
		}else {
			reportList = reportRepo.findByReportAnswerIsNotNull(pageable3);
		}
		int nowPage3 = reportList.getPageable().getPageNumber()+1;
