...
public class NoticeController {
	...
	public String noticeView(Model model, Long noticeSeq,
							@PageableDefault(page = 0, size = 2, sort = "noticeSeq", direction = Sort.Direction.DESC)Pageable pageable,
							String searchKeyword, @RequestParam(defaultValue = "") String searchCode, String noticeChoice,
							Principal principal, ModelMap modelMap) {
		...
		noticeService.getNoticeView(model, noticeSeq, pageable, searchKeyword, searchCode, noticeChoiceL);
